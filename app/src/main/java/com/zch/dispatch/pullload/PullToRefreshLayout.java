package com.zch.dispatch.pullload;
...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	public boolean canPullDown = true;
		...
		case MotionEvent.ACTION_MOVE:
			if (mEvents == 0)
			{
								...
								&& canPullDown && state != LOADING))
				{
					...
					//----处理与viewpager滑动冲突---------begin
					float deltaX = Math.abs(ev.getX() - mDownPosX);
					float deltaY = Math.abs(ev.getY() - mDownPosY);
