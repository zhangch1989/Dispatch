package com.zch.dispatch.datetime;
...
public class PowerDateUtils {
	...
	public static String getMonthStr(int year, int month) {
		long time = componentMonthToTimestamp(year, month);

		return Date10String(time);
	}

	public static String getYearStr(int year) {
		long time = componentYearToTimestamp(year);

		return Date20String(time);
	}
	 ...
	 *            月
	 */
	public static long componentMonthToTimestamp(int year, int month) {
	 ...
	 * @return
	 */
	public static long componentYearToTimestamp(int year) {
	...
	public static String Date3String(long time) {
		...
		return DateFormat.format("yyyy-MM-dd HH", time).toString();
	}
	...
	public static String Date4String(long time) {
		...
		return DateFormat.format("yyyy年MM月dd日HH时", time).toString();
	}
	...
	public static String Date11String(long time) {
		...
		return DateFormat.format("yyyy年MM月dd日HH时mm分", time).toString();
	}
	...
	public static String Date10String(long time) {
		if (time == 0) {
			return "";
		}
		return DateFormat.format("yyyy-MM", time).toString();
	}
	public static String Date20String(long time) {
		if (time == 0) {
			return "";
		}
		return DateFormat.format("yyyy", time).toString();
	}
